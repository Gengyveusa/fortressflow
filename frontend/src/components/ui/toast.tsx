...
const toastVariantClasses: Record<ToastVariant, string> = {
  ...
  destructive:
    "bg-red-600 dark:bg-red-700 border border-red-700 dark:border-red-800 text-white",
  success:
    "bg-green-600 dark:bg-green-700 border border-green-700 dark:border-green-800 text-white",
};
...
>(({ className, variant = "default", ...props }, ref) => (
  <ToastPrimitives.Root
    ref={ref}
    className={cn(
      "group pointer-events-auto relative flex w-full items-center justify-between gap-4 overflow-hidden rounded-lg px-4 py-3 pr-8 shadow-lg transition-all",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ...
    className={cn(
      ...
      "hover:bg-black/10 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
      className
    )}
    {...props}
  />
