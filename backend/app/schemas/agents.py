...
class ApolloPersonSearchRequest(BaseModel):
    ...
    person_seniorities: list[str] | None = Field(None, description="Seniority levels: owner, founder, c_suite, vp, director, manager")
    organization_industry_tag_ids: list[str] | None = Field(None, description="Industry tags for filtering")
    organization_num_employees_ranges: list[str] | None = Field(None, description="Employee count ranges (e.g. ['1,10', '11,50'])")
...
class ApolloOrganizationSearchRequest(BaseModel):
    ...
    organization_revenue_ranges: list[str] | None = Field(None, description="Revenue ranges (e.g. ['1000000,10000000'])")
