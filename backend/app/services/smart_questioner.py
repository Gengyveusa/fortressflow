...
INTENT_REQUIREMENTS: dict[str, dict[str, Any]] = {
    ...
    # ── v2.0 Marketing Agent intents (no required — agents have defaults) ──
    "score_lead": {"required": [], "optional": ["name", "company", "specialty", "location"], "defaults": {}},
    "segment_customers": {"required": [], "optional": [], "defaults": {}},
    "create_social_post": {"required": [], "optional": ["linkedin_topic"], "defaults": {}},
    "optimize_send_time": {"required": [], "optional": [], "defaults": {}},
    "generate_landing_page": {"required": [], "optional": ["product"], "defaults": {}},
    "demand_gen": {"required": [], "optional": ["topic"], "defaults": {}},
    "upsell_crosssell": {"required": [], "optional": [], "defaults": {}},
    "event_promotion": {"required": [], "optional": [], "defaults": {}},
    "multilingual_content": {"required": [], "optional": ["locale", "content"], "defaults": {"locale": "es"}},
    "translate_content": {"required": [], "optional": ["locale", "content"], "defaults": {"locale": "es"}},
    "chatbot_response": {"required": [], "optional": [], "defaults": {}},
    # ── v2.0 Sales Agent intents ──
    "manage_pipeline": {"required": [], "optional": ["company", "action_type"], "defaults": {"action_type": "analyze"}},
    "schedule_meeting": {"required": [], "optional": ["contact", "time"], "defaults": {}},
    "generate_quote": {"required": [], "optional": ["company"], "defaults": {}},
    "score_opportunity": {"required": [], "optional": ["company"], "defaults": {}},
    "account_insights": {"required": [], "optional": ["company"], "defaults": {}},
    "renewal_recommendation": {"required": [], "optional": [], "defaults": {}},
    "revenue_forecast": {"required": [], "optional": ["timeframe"], "defaults": {"timeframe": "next_quarter"}},
    "log_call_transcript": {"required": [], "optional": ["transcript"], "defaults": {}},
    "automated_followup": {"required": [], "optional": [], "defaults": {}},
    # ── v2.0 Platform intents ──
    "churn_analysis": {"required": [], "optional": [], "defaults": {}},
    "dedup_check": {"required": [], "optional": [], "defaults": {}},
    "experiment_status": {"required": [], "optional": [], "defaults": {}},
    "community_stats": {"required": [], "optional": [], "defaults": {}},
    "call_analytics": {"required": [], "optional": [], "defaults": {}},
    "plugin_marketplace": {"required": [], "optional": [], "defaults": {}},
    # ── Other agent intents ──
    "apollo_search": {"required": [], "optional": ["apollo_query"], "defaults": {}},
    "apollo_sequence": {"required": [], "optional": ["sequence_name"], "defaults": {}},
    "linkedin_post": {"required": [], "optional": ["linkedin_topic"], "defaults": {}},
    "linkedin_dm": {"required": [], "optional": [], "defaults": {}},
    "send_whatsapp": {"required": ["whatsapp_number", "whatsapp_body"], "optional": [], "defaults": {}},
    "search_company": {"required": [], "optional": ["company_query"], "defaults": {}},
    "ai_generate": {"required": [], "optional": ["ai_prompt"], "defaults": {}},
    "plan_outreach": {"required": [], "optional": ["target_description", "location", "channels"], "defaults": {}},
    "sync_crm": {"required": [], "optional": [], "defaults": {}},
    "send_sms": {"required": ["phone_number", "sms_body"], "optional": [], "defaults": {}},
}
