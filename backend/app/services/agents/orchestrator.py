...
_ALLOWED_ACTIONS: dict[str, set[str]] = {
    ...
    "marketing": {
        ...
        "create_demand_gen_sequence",
        "segment_customers",
        "recommend_upsell_crosssell",
    ...
    "sales": {
        "enrich_lead",
        "advanced_lead_search",
        "manage_pipeline",
        "create_automated_followup",
        "schedule_task",
        "log_call",
        "enroll_in_sequence",
